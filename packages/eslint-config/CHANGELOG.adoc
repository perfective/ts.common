...
* Upgraded `eslint` to `7.7.0`.
* Upgraded `@typescript-eslint` to `3.10.1`.
* Upgraded `eslint-plugin-jest` to `23.20.0`.
* Upgraded `eslint-plugin-rxjs` to `0.0.02-beta.29`.
* Upgraded `eslint-import-resolver-typescript` to `2.2.1`.
