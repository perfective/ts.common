...
The `link:https://github.com/perfective/ts.common/blob/main/src/result/index.adoc[@perfective/common/result]` package provides a `Result` monad
...
+
* `link:https://github.com/perfective/ts.common/tree/main/src/promise/index.adoc[@perfective/common/promise]`
